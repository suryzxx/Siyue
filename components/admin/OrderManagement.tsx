...
const MOCK_ORDERS: OrderData[] = [
  ...
  // === 分期-已支付秋上 ===
  { id: 'ORD-F001', orderTime: '2026-02-01 10:00:00', paymentTime: '2026-02-01 10:05:00', totalAmount: 5475, subOrders: [{ id: 'SUB-F001', realPay: 2500, paymentMethod: '微信支付', studentId: '5009', studentName: '吴佳怡', studentPhone: '153****9900', status: OrderStatusEnum.SUCCESS, orderType: '续报', semester: '秋季', firstPeriod: 2500, secondPeriod: 2975, items: [{ id: 'i25', name: '25秋-G1-A+--秋上', classId: 'c_p3', type: 'course', price: 2500 }, { id: 'i26', name: '教辅费', classId: '', type: 'material', price: 0 }], classInfo: { className: '25秋-G1-A+--一期', campus: '大行宫校区', teacher: 'Ruby张露', schedule: '周六 08:30-11:00' }, statusHistory: [{ status: '创建订单', time: '2026-02-01 10:00:00', remark: '秋季分期，秋上¥2500 + 秋下¥2975' }, { status: '已支付', time: '2026-02-01 10:05:00', remark: '秋上¥2500已付' }] }] },
  // === 分期-待续费 ===
